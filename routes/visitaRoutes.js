...
import { getUsuarioVisitas, getVisitas, getVisitasMunicipio, getVisitasPeriodo, crearVisita, editarVisita, eliminarVisita, getVisita } from '../controllers/visitaController.js'
...
router.get('/municipios', checkAuth, getVisitasMunicipio)
